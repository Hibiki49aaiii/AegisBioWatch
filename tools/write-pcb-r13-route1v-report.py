...
SRC_PCB=ROOT/'hardware/main-board/pcb/route-r13-1u/AegisBioWatch-MainBoard-Route1u-r13.kicad_pcb'; SRC_REPORT=ROOT/'hardware/main-board/pcb/route-r13-1u/routing-seed-r13-1u.json'
OUT_DIR=ROOT/'hardware/main-board/pcb/route-r13-1v'; OUT_PCB=OUT_DIR/'AegisBioWatch-MainBoard-Route1v-r13.kicad_pcb'; OUT_REPORT=OUT_DIR/'routing-seed-r13-1v.json'
...
def main():
    ...
    out={
      ...
      'track_segments_added':2,'vias_added':0,'track_width_mm':0.20,
      'connections':{'+1V8':{'u2_12_mm':[11.1875,30.95],'bend_mm':[11.1875,31.45],'c113_1_mm':[12.245188,32.399818],'c113_value':'100nF X5R'}},
      'rejected_geometry':{'type':'direct U2.12 to C113.1 segment','run_id':31471988394,'artifact_id':9093754195,'failure':'short and solder-mask bridge to adjacent U2.13/SYS_I2C_SDA'},
