...
def main():
    ...
    out={
      ...
      'track_segments_added':4,'vias_added':1,'sense_track_width_mm':0.30,'gnd_track_width_mm':0.30,'via_size_mm':0.60,'via_drill_mm':0.30,
      'c105':{'value':'1.0uF X5R 10V','center_mm':[16.185102,25.381239],
        ...
        'u2_22_vbusout_sense_mm':[13.8875,27.75],'escape_x_mm':14.10,'gnd_via_mm':[17.70,25.38],'gnd_reference':'continuous In1.Cu GND zone'},
