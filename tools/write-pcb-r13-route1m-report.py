...
def main():
    ...
    out={
      ...
      'c106':{'value':'2.2uF X7R 16V','center_mm':[15.522674,29.714978],'vbat_pad_mm':[15.522674,28.939978],'gnd_pad_mm':[15.522674,30.489978],
        'u2_19_vbat_mm':[13.8875,29.25],'gnd_via_mm':[16.35,30.49],'gnd_reference':'continuous In1.Cu GND zone'},
