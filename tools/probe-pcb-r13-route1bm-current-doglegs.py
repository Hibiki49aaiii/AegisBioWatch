#!/usr/bin/env python3
"""Read-only current-state Manhattan screen for ordinary route-1bl ratsnest pairs."""
...
def main() -> None:
    ...
    out = {
        "revision": "r13-route1bm-current-manhattan-dogleg-screen",
    ...
    if out["board_modified"] is not False or out["raw_pair_count"] < 100:
        raise SystemExit("route1bm current dogleg state gate failed")
